...
{% content-ref url="v0.2.0.x-series.md" %}
[v0.2.0.x-series.md](v0.2.0.x-series.md)
{% endcontent-ref %}

***

## <mark style="color:$primary;">Older supported series</mark>
...
## <mark style="color:$primary;">Deprecated series</mark>

Here is a list of the deprecated older version series through the lifetime of Nitrocid KS.

### <mark style="color:$primary;">API v3.1 series</mark>
...
### <mark style="color:$primary;">API v2.0 series</mark>
...
### <mark style="color:$primary;">API v1.3 series</mark>
...
### <mark style="color:$primary;">API v1.2 series</mark>
...
### <mark style="color:$primary;">API v1.1 series</mark>
...
### <mark style="color:$primary;">API v1.0 series</mark>
