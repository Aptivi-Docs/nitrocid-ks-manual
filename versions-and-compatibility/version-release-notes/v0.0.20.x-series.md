...
This series was the first series which got released on the year 2022. Since the first version which celebrated the fourth-year anniversary of the first release of Kernel Simulator, it has gained various improvements in different areas of the kernel.
