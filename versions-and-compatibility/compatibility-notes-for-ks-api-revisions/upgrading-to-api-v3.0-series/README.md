...
API v3.0 is now in service pack maintenance mode, but the breaking changes might still get committed and get landed here. They describe what broke and what should be used instead.
