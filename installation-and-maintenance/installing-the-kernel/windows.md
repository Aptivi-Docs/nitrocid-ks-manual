---
description: How to install Kernel Simulator on Windows
---

# 💻 Windows

Installing Kernel Simulator on Windows is pretty easy, but we recommend installing the simulator using the Chocolatey package manager.
...
There are several ways to install Kernel Simulator on Windows systems. We recommend installing KS using the Chocolatey package manager for simplicity.

### Method 1: Chocolatey

This step-by-step guide shows you how to install Kernel Simulator using the package manager, [Chocolatey](https://chocolatey.org/install), assuming that you already have it on your system.
...
3. Start Kernel Simulator using `ks`
...
5. Open your favorite terminal emulator, like ConEmu, and change the working directory to a folder containing the Kernel Simulator executable
6. Execute `ks` or `Kernel Simulator.exe` to start the kernel
