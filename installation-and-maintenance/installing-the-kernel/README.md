...
As for upgrading to 0.1.0, old configuration styles are no longer supported and are kept in your home directory for reference. However, starting from 0.1.0.5, you can migrate most of your old-style configuration (as early as 0.0.16.0 released on 2021) to 0.1.0 and later. See why [here](https://gitlab.com/aptivi/docs/stable/nks-manual-0-2-0-rtm/-/blob/main/versions-and-compatibility/compatibility-notes-for-ks-api-revisions/upgrading-to-api-v3.0-series/from-0.1.0-beta-2-to-0.1.0-beta-3.md).
...
{% content-ref url="https://gitlab.com/aptivi/docs/stable/nks-manual-0-2-0-rtm/-/blob/main/versions-and-compatibility/compatibility-notes-for-ks-api-revisions/README.md" %}
[https://gitlab.com/aptivi/docs/stable/nks-manual-0-2-0-rtm/-/blob/main/versions-and-compatibility/compatibility-notes-for-ks-api-revisions/README.md](https://gitlab.com/aptivi/docs/stable/nks-manual-0-2-0-rtm/-/blob/main/versions-and-compatibility/compatibility-notes-for-ks-api-revisions/README.md)
{% endcontent-ref %}
