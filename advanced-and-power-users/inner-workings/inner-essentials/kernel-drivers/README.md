...
<summary>Driver class implementation</summary>
...
<summary>Registering a kernel driver</summary>

If you have a kernel driver that you wish to register, you'll have to register the kernel driver, passing it the `IDriver` interface for your driver and the appropriate type.
...
<table><thead><tr><th width="245">Function</th><th>Description</th></tr></thead><tbody><tr><td><code>BeginLocalDriverSafe&#x3C;T>()</code></td><td>This notifies the kernel that the mod is going to use the provided driver temporarily.</td></tr><tr><td><code>EndLocalDriver&#x3C;T>()</code></td><td>This notifies the kernel that the mod is done with the temporary driver.</td></tr></tbody></table>
...
<summary>Fallback drivers</summary>

Additionally, the driver management API provides you an easy way to get the default driver that the kernel declares.

You can use the below functions:

<table><thead><tr><th width="405.666748046875">Function</th><th>Description</th></tr></thead><tbody><tr><td><code>GetFallbackDriver&#x3C;TDriverInterfaceType>()</code></td><td>This returns an instance of the default driver that the kernel initialized before drivers get set by the config reader.</td></tr><tr><td><code>GetFallbackDriverName&#x3C;TDriverInterfaceType>()</code></td><td>This returns the actual driver name grabbed from the dictionary.</td></tr></tbody></table>
...
<summary>Current drivers</summary>
...
<table><thead><tr><th width="226.333251953125">Function</th><th>Description</th></tr></thead><tbody><tr><td><code>GetCurrentDriver()</code></td><td>Returns the current driver that's used by the kernel.</td></tr><tr><td><code>GetCurrentDriverLocal()</code></td><td>Returns the current local driver set by <code>BeginLocalDriver&#x3C;T>()</code> or its safe sibling function.</td></tr></tbody></table>
