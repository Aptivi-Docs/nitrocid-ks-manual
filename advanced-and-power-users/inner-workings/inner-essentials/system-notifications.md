...
## <mark style="color:$primary;">Types of notifications</mark>
...
## <mark style="color:$primary;">Notification tools</mark>

The notification API provides the following tools for your mods to use:
...
<summary>Notification dismissal</summary>
...
<summary>Notification comparison</summary>
...
<summary>Notification history export</summary>

You can also export the recent notifications list by either using the admin shell to invoke a command called `savenotifs` or, programmatically, using a function called `SaveRecents()` from the notification manager class.
